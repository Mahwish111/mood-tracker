...
mood = st.selectbox("Select your mood", ["Happy", "Sad", "Angry", "Neutral", "Stressed"])
...
# Create section for Visualization
    st.subheader("Mood Trends Over The Time")
...
# Build with love by Mahwish Imran
st.write("Build  with ❤ by Mahwish Imran")
